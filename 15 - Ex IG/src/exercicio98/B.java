...
public class B {
	...
	public void inicializaFormulario() {
		...
		rotulo.setText("Informe um numero ");
		rotulo.setBounds(10, 20, 450, 20);

		JLabel rotulo1 = new JLabel();
		rotulo1.setText("Informe outro numero ");
		...
		botao.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, Double.parseDouble(String.valueOf(campo.getText())) * Double.parseDouble(String.valueOf(campo1.getText())));
